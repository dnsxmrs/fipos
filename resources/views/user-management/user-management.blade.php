...
<div class="main-frame">
    ...
    <div class="content">
        ...
        <div class="left-panel">
            ...
            <h2><a href="role_management.html" style="text-decoration: none; color: #333;">Role Management</a></h2>
            <p>Manage roles and permissions</p>

            <!-- New Edit Profile Option -->
            <h2><a href="edit_profile.html" style="text-decoration: none; color: #333;">Edit Profile</a></h2>
            ...
            <table class="user-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>asinero.shanella@gmail.com</td>
