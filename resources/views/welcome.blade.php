                ...
                <div class="bg-white border rounded-md shadow-md p-6 w-[1450px]">
                    ...
                    <div id="edit-dialog"
                        ...
                        <div class="bg-white rounded shadow-md p-8 flex flex-col items-center"
                            style="width: 455px; height: 814px;">
                    ...
                    <table class="border-collapse w-[1400px] mt-7">
                        ...
                        <tbody>
                            <tr class="border-b border-gray-300">
                                ...
                                <td class="p-2">89</td>
                                <td class="p-2">
                                    <span class="text-xs text-green-500 rounded-md px-2 py-1"
                                        style="background-color: #DCF8F0">Available</span>
                                </td>
                            ...
                            <tr class="border-b border-gray-300">
                                ...
                                <td class="p-2">89</td>
                                <td class="p-2">
                                    <span class="text-xs text-red-500 rounded-md px-2 py-1"
                                        style="background-color: #FFDFDF">Not Available</span>
                                </td>
                                <td class="py-2 px-4 flex space-x-2">
                                    <button onclick="showEditDialog()"
                                    ...
                                    <button onclick="showDeleteDialog()"
                                        class="flex items-center text-red-500 hover:text-red-700 ml-2">
                                        <img src="{{ asset('Assets/Delete.png') }}" alt="Delete Icon"
                                            class="mr-2 ml-2">
                                    </button>
                                </td>
