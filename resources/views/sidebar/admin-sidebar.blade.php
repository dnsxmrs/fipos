...
<div class="w-20 h-full bg-white border-r flex flex-col items-center py-6">
    ...
    {{-- Dashboard --}}
    <button onclick="window.location.href='{{ route('admin.dashboard') }}  aria-label="Reports" class="flex flex-col items-center">
    ...
    <!-- Menu Labels -->
    <button onclick="window.location.href='{{ route('admin.menu') }} aria-label="Menu" class="flex flex-col items-center">
        <div class="w-10 h-10 rounded-lg mb-2"></div>
