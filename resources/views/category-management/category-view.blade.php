...
<!--sidebar for cat&products-->
        <div class="flex space-x-6 h-[870px]">
            <div class="bg-white border rounded-md shadow-md w-[285px]">
                <button class="flex items-center text-left rounded-lg font-barlow text-xl mt-9 mb-4 ml-2 w-[268px] h-[76px] text-black" style="background-color: #E8C9B2;">
                    <img src="{{ asset('Assets/category-icon.png') }}" alt="Category Icon" class="w-6 h-6 mr-2 ml-2">
            ...
            <tbody>
                <tr class="border-b border-gray-300">
                    ...
                    <td class="py-2 px-4 flex space-x-2">
                        ...
                        <button onclick="showDeleteDialog()" class="flex items-right text-red-500 hover:text-red-700 ml-2 transition duration-300 ease-in-out">
