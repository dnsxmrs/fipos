...
<body>
    ...
    <div class="flex h-screen bg-[rgb(243,243,243)]">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <!--sidebar for cat&products-->
            <div class="flex space-x-6 h-[870px]">
                <div class="bg-white border rounded-md shadow-md w-[285px]">
                    <button
                        class="flex items-center text-left rounded-lg font-barlow text-xl mt-9 mb-4 ml-2 w-[268px] h-[76px] text-black"
                        style="background-color: #E8C9B2;">
                        <img src="{{ asset('Assets/category-icon.png') }}" alt="Category Icon"
                            class="w-6 h-6 mr-2 ml-2">
                        <span class="ml-2">Categories</span>
                    </button>

                    <button class="flex items-center text-left font-barlow text-xl mb-1 w-[282px] h-[50px] text-black">
                ...
                <div class="bg-white border rounded-md shadow-md p-6 w-[1450px]">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center border border-gray-300 rounded-full w-[314px] p-2 mt-2">
                            <img src="{{ asset('Assets/search-icon.png') }}" alt="Search Icon"
                                class="w-6 h-6 mr-2 ml-2">
                    ...
                    <div id="add-dialog"
                        ...
                        aria-hidden="true">
                        <div class="bg-white shadow-md p-8 flex flex-col items-center rounded-lg"
                            style="width: 455px; height: 750px;">
                            ...
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <select
                                    class="mt-4 w-[350px] h-[42px] border border-gray-300 rounded-md p-2 text-sm mb-1">
                                ...
                                <div class="flex flex-col items-center mt-4">
                                    <div class="relative w-[350px] mb-4">
                                        ...
                                        <label
                                            ...
                                            for="itemName">Category no.</label>
                                    </div>
                                    ...
                                    <div class="relative w-[350px] mb-4">
                                        ...
                                        <label
                                            class="text-sm absolute left-2 top-2 transform transition-transform duration-300 ease-in-out scale-100 text-gray-500 origin-left peer-placeholder-shown:top-2 peer-placeholder-shown:left-2 peer-placeholder-shown:scale-100 peer-focus:-top-5 peer-focus:left-2 peer-focus:scale-75"
                                            for="itemPrice">Category name</label>
                                    </div>

                                    <button onclick="showItemUpdatedDialog()"
                    ...
                    <div id="item-updated-dialog"
                        ...
                        aria-hidden="true">
                        <div
                            class="bg-white shadow-md p-8 flex flex-col items-center w-[500px] h-[350px] rounded-[20px] overflow-hidden">
                            <img src="{{ asset('Assets/icon-success.png') }}" alt="Success Icon"
                                class="w-[150px] h-[150px]">
                            <h1 class="text-center text-2xl font-bold mb-2 font-barlow mt-2">Category added
                                successfully!</h1>
                    ...
                    <div id="edit-dialog"
                        class="hidden fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 transition-opacity duration-200 z-50"
                        aria-hidden="true">
                        <div class="bg-white rounded shadow-md p-8 flex flex-col items-center"
                            style="width: 455px; height: 730px;">
                    ...
                    <div id="added-dialog"
                        ...
                        aria-hidden="true">
                        <div
                            class="bg-white shadow-md p-8 flex flex-col items-center w-[500px] h-[370px] rounded-[20px] overflow-hidden">
                            <img src="{{ asset('Assets/update-icon.png') }}" alt="Success Icon"
                                class="w-[150px] h-[150px]">
                    ...
                    <div id="delete-dialog"
                        ...
                        <div
                            class="bg-white shadow-md p-8 flex flex-col items-center w-[500px] h-[350px] rounded-[20px] overflow-hidden">
                            <img src="{{ asset('Assets/icons-delete.png') }}" alt="deleteIcon"
                                class="w-[150px] h-[150px]">
                    ...
                    <div id="success-modal"
                        ...
                        <div
                            ...
                            <img src="{{ asset('Assets/icons-password.png') }}" alt="Password Icon"
                    ...
                    <div id="item-deleted-modal"
                        ...
                        <div
                            ...
                            <img src="{{ asset('Assets/icon-success.png') }}" alt="deleteIcon"
                                class="w-[150px] h-[150px] mb-4">
                    ...
                    <!-- Category Table -->
                    <table class="border-collapse w-[1400px] mt-9">
                        <thead>
