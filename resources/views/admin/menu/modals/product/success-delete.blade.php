...
<div id="item-deleted-modal-products" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full min-w-fit max-w-md h-full md:h-auto">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
            ...
            <p class="mb-4 text-lg font-semibold text-gray-900">Product deleted successfully.</p>
            <button onclick="hideSuccessMessage()" type="button"
