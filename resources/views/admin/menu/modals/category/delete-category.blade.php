<!-- Delete Modal -->
<div id="delete-dialog-categories" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow ">
            <button type="button" onclick="hideDeleteDialogCategories()"
            ...
            <div class="p-4 md:p-5 text-center">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="my-5 bg-gray-100 p-2 rounded-full fill-red-500 w-14 inline" viewBox="0 0 24 24">
                        <path
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 ">Are you sure you want to delete
                    this category?</h3>
                <button type="button" onclick="showConfirmDeleteCategories()"
