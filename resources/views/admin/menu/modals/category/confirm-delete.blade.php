...
<div id="confirm-delete-dialog-categories" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
            <button type="button" onclick="hideConfirmDeleteCategories()"
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <form action="{{ route('admin.menu.categories.delete') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <a onclick="hideConfirmDeleteCategories()"
