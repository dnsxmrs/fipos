...
<div id="confirm-delete-modal-user" tabindex="-1"
    ...
    <div class="relative w-full max-w-md max-h-full p-4">
        <div class="relative bg-white rounded-lg shadow">
            <button type="button" onclick="hideConfirmDeleteModalUsers()"
            ...
            <div class="p-4 text-center md:p-5">
                ...
                <h3 class="mb-3 text-base font-normal text-gray-500">Enter your password to delete this user</h3>
                <form action="{{ route('admin.user.delete') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <a onclick="hideConfirmDeleteModalUsers()"
