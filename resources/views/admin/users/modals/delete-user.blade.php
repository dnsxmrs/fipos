...
<div id="delete-dialog-users" tabindex="-1"
    ...
    <div class="relative w-full max-w-md max-h-full p-4">
        <div class="relative bg-white rounded-lg shadow ">
            <button type="button" onclick="hideDeleteDialogUsers()"
            ...
            <div class="p-4 text-center md:p-5">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="inline p-2 my-5 bg-gray-100 rounded-full fill-red-500 w-14" viewBox="0 0 24 24">
                        <path
