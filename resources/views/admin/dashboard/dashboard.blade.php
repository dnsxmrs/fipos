...
@section('admin_content')
    ...
    <div class="flex flex-col min-h-screen ">
        ...
        <div class="flex items-center justify-between">
            <div class="my-3 mb-7">
                <p class="text-xl font-medium text-gray-700">Dashboard</p>
            </div>
        </div>
        ...
        <div class="flex flex-col flex-1 gap-8 p-5 overflow-auto lg:flex-row">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 ">
                ...
                <div class="p-5 text-center bg-white rounded-lg shadow-md border-2 border-solid">
                ...
                <div
                    class="p-5 text-center bg-white rounded-lg shadow-md border-2 border-transparent">
                        ...
                        <table class="w-full mt-2 border-collapse">
                            <thead>
                                <tr class="bg-gray-100">
                                    ...
                                    <th class="px-4 py-2 text-sm font-semibold text-left text-gray-700 border-b">Quantity
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
