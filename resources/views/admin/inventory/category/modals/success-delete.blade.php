...
<div id="success_category_delete"
    ...
    <div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
        ...
        <div class="my-8 text-center">
            ...
            <h4 class="text-xl text-gray-800 font-semibold mt-4">Category deleted successfully!</h4>
            <p class="text-sm text-gray-500 leading-relaxed mt-4 text-wrap">The category has been successfully deleted from the list.</p>
        </div>
