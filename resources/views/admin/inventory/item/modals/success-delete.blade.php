...
<div id="success_item_delete" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full min-w-fit max-w-md h-full md:h-auto">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
            <button type="button" onclick="hideSuccessDeleteModal()"
            ...
            <p class="mb-4 text-lg font-semibold text-gray-900">Item deleted successfully.</p>
            <button onclick="hideSuccessDeleteModal()" type="button"
