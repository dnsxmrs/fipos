...
<div id="confirm_delete_modal" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
            <button type="button" onclick="hideConfirmDeleteModal()"
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <form action="{{ route('admin.inventory.item.destroy') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="" name="delete_item_id" id="delete_item_id">
                    ...
                    <a onclick="hideConfirmDeleteModal()"
