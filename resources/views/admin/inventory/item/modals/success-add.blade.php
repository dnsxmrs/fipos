{{-- SUCCESS ADD MODAL --}}
<div id="success_item_add" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full min-w-fit max-w-md h-full md:h-auto">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
            <button type="button" onclick="hideSuccessAddModal()"
            ...
            <p class="mb-4 text-lg font-semibold text-gray-900">Item added successfully.</p>
            <button onclick="hideSuccessAddModal()" type="button"
