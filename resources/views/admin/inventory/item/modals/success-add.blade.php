...
<div id="success_item_add"
    ...
    <div class="bg-white shadow-md p-8 flex flex-col items-center w-96 h-auto py-10 px-5 rounded-[20px] overflow-hidden">
        ...
        <h1 class="text-center text-2xl font-bold mb-4 text-wrap">Item Added Successfully</h1>
        <h2 class="text-center mb-2 text-sm text-wrap">The item has been successfully added
